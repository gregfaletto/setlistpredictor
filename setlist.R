# setwd("/Users/gregfaletto/Google Drive/Data Science/R/Live Nation")
...
# Contact E-Mail	Gregory.Faletto@marshall.usc.edu
# Description	Interested in using data for a personal non-commercial side project; may be interested for non-commercial research purposes at a later time.
# API Key	
# 7eKcv3bYDjXADJEMxORWXfxAkuPT-0ZfOPQG
# Rate limit max. 2.0/second and max. 1440/DAY. - Request upgrade/edit details
# https://www.setlist.fm/report/app/change?app=43d6bb4b
...
key <- "7eKcv3bYDjXADJEMxORWXfxAkuPT-0ZfOPQG" # applied for this key on 05/15/19
...
# mbid <- "650e7db6-b795-4eb5-a702-5ea2fc46c848" # lady gaga
